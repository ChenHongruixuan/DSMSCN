...
if __name__ == '__main__':
    ground_truth_changed = imageio.imread('../unsupervised/result/change.bmp')
    ground_truth_unchanged = imageio.imread('../unsupervised/result/unchanged.bmp')

    cm_path = '../unsupervised/result/IRMAD_Taizhou.png'
